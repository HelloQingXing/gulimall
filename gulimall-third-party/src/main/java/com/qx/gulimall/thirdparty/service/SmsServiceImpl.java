...
import com.qx.gulimall.thirdparty.util.SmsProperties;
...
public class SmsServiceImpl implements SmsService {
    ...
    private boolean sendSms(String phoneNum,String code){
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", smsProperties.getKeyId(), smsProperties.getKeySecret());
        try {
